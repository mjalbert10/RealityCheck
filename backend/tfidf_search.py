...
if CACHE_PATH.exists():
    ...
    tfidf_matrix = np.stack(df["all_tokens"].apply(tfidf_vectorize).values).astype(np.float32)
    np.savez(CACHE_PATH, cosine_matrix=cosine_matrix, tfidf_matrix=tfidf_matrix)
